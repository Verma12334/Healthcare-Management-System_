...
<header>
    ...
    <?php
        ...
        if(isset($_POST['login']))
        {
            ...
            if($login=="Medical Staff")
            {
            header("Location:medical_staff.php"); 
            }
            else if($login=="Non-Medical Staff")
            {
            header("Location:non_medical_staff.php"); 
            }
                    ...
                    <div class="col-span-6 sm:col-span-3">
                        <div class="pl-2 mt-2">
                            <select id="login" name="login" autocomplete="login"
                                ...
                                <option>Non-Medical Staff</option>
                            </select>
                        </div>
                    </div>
