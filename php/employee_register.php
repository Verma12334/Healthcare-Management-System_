...
require_once 'connect.php';
		//$name = $dob = $gender=$age = $number = $email= $address = $experience = $working = $type=$password ="";
    
    if(isset($_POST['name']) && isset($_POST['dob']) && isset($_POST['gender']) && isset($_POST['age']) && isset($_POST['number'])  && isset($_POST['experience']) && isset($_POST['working']) && isset($_POST['type']) && isset($_POST['email'])  && isset($_POST['password']))
    {  
    ...
    // $servername = "localhost";
		...
		// $dbname = "health";
		  ...
		  $sql = "INSERT INTO $myDB.employee (`name`,`dob`,`gender`,`age`,`email`,`contact_no`,`availability`,`work_experience`,`e_type`,`pass_wrd`) VALUES ('$name', '$dob','$gender', '$age', '$email', '$number', '$working','$experience','$type','$password')";
