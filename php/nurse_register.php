...
require_once 'connect.php';
    ...
    // $servername = "localhost";
	    ...
	    //       $val = "SELECT MAX(eid) $myDB.employee";
		  // $sql = "INSERT INTO $myDB.nurse (`nid`,`specialisation`,`qualification`) VALUES (`$val`,'$specialisation','$qualification')";
      ...
      try {
        ...
        $sql = "INSERT INTO $myDB.nurse (nid, specialisation, qualification) VALUES (:nid, :specialisation, :qualification)";
        $stmt = $conn->prepare($sql);
        $stmt->bindParam(':nid', $maxEid, PDO::PARAM_INT); // Bind max `eid` as `did`
