<?php
   ...
   require_once 'connect.php';
     ...
     {   
         ...
         if($val["pass_wrd"] != $password || $val["e_type"] != "Nurse")
          {
          header("Location:error.php"); 
          exit();
          }
          else {
            $stmt1 = $conn->query("SELECT * FROM $myDB.nurse N JOIN $myDB.employee E WHERE E.email='$email' AND E.pass_wrd='$password' AND N.nid=E.eid;");
    ...
    {     
        $stmt2 = $conn->query("SELECT * FROM $myDB.nurse N JOIN $myDB.employee E ORDER BY N.nid DESC LIMIT 1;");
...
<body>
    ...
    <div class="patient-container">
        ...
        <div class="left-panel">
            ...
            <p><strong>Id:</strong> <?php echo $data['nid']?></p>
